...
def relation_extraction():
    ...
    #
    #
    # # 将数据中int类型全部转成string,不是字符串可能会报错
    ...
    # print(df_data)
    df_tem = pd.DataFrame(invoice_data)
    df_data = df_tem[['购买方名称','金额','销售方名称']]
    df_data.rename(columns={'购买方名称':'buy','销售方名称':'sell','金额':'money'},inplace=True)
    print(df_data)
    return df_data
